...
def check_translations(
    ...
    return ff6a_arabic.check_ff6a_translations(font, *previews, translations=translations)
...
def build(
    ...
    result = ff6a_arabic.build_ff6a_arabic_rom(rom, font, translations=translations)
...
def extract(image: Path, translations: TranslationSet | None = None) -> tuple[str, dict[str, str]]:
    ...
    origin = f"{ff6a_arabic.IMAGE.title} image, SHA-256 {ff6a_arabic.IMAGE.sha256}"

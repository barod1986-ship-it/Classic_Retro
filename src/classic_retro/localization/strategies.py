...
The fourteen reference targets proved three strategies; they are a starting set,
...
Twelve of the fourteen targets turn the text right to left at one point of the
